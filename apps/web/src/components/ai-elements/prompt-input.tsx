...
/* eslint-disable react-hooks/set-state-in-effect, react-hooks/refs, @typescript-eslint/no-unused-vars, @typescript-eslint/no-explicit-any, @next/next/no-img-element -- vendored from deer-flow, kept as upstream */
...
// Local ChatStatus replaces the Vercel AI SDK type (idle | submitted | streaming | error).
  ...
  return (
    <PromptInputHoverCard>
      <HoverCardTrigger asChild>
        <div
          className={cn(
            "group bg-muted hover:bg-accent hover:text-accent-foreground dark:hover:bg-accent/50 relative flex h-8 cursor-pointer items-center gap-1.5 rounded-md px-1.5 text-sm font-medium transition-all select-none",
            className,
          )}
          key={data.id}
          {...props}
