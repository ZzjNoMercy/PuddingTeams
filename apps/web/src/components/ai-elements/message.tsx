...
// Adapted from deer-flow ai-elements/message.tsx (MIT). The `ai`-package types
// were replaced with local ones and attachment parts dropped; everything else
// keeps the upstream visual structure.
