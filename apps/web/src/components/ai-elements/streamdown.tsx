...
// recursive tokenizers — deep nesting overflows the call stack during render.
// If rendering a message throws, fall back to plain pre-formatted text.
...
export function ClipboardSafeStreamdown({
	...
	const sanitizedChildren =
		typeof children === "string" ? preprocessStreamdownMarkdown(children) : children;
